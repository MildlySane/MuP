...
void  TargetResetInit(void)
{
  ...
  CCLKCFG   = 3;                       /* Configure the ARM Core Processor clock divider           */ //Divides the PLL Clk O/p by CCLKCFG+1
  USBCLKCFG = 5;                    	/* Configure the USB clock divider                         */ //Same as above, but for USB

  while ((PLLSTAT & 0x04000000) == 0);  
  
  PCLKSEL0  = 0xAAAAAAAA;          	/* Set peripheral clocks to be half of CPU clock          */ //CCLK/2
  PCLKSEL1  = 0x22AAA8AA;
